...
report_area > PWM_area.txt

# min and max timing reports
report_timing -path full -delay max -nworst 3 > PWM_max_timing.txt
report_timing -path full -delay min -nworst 3 > PWM_min_timing.txt

# net list
write -format verilog PWM -output PWM.vg
