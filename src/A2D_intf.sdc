# Read all files
read_file -format sverilog {A2D_intf.sv SPI_mnrch.sv}

# Set current design to A2D_intf (top module)
current_design A2D_intf
...
report_area > A2D_intf_area.txt

# min and max timing reports
report_timing -path full -delay max -nworst 3 > A2D_intf_max_timing.txt
report_timing -path full -delay min -nworst 3 > A2D_intf_min_timing.txt

# net list
write -format verilog A2D_intf -output A2D_intf.vg
